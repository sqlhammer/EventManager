...
- [ ] CONSTRUCTION: U7 Offline Resilience — **NEXT** (branch `unit/u7-offline-resilience`); cross-cutting: hub→cloud replication client + outage replay + completeness, spoke offline queue/reconnect integration, zero-internet property. Touches shared/admin/judge/checkin.
