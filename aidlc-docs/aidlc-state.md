...
- [ ] CONSTRUCTION: U6 Check-In — **fast-tracked; code complete on branch `unit/u6-checkin`** (`checkin/EventManager.Checkin.Core` + compiling MAUI Windows head + 5 tests; check-in + weigh-in range validation + non-binding recommendation). FINAL unit. Awaiting merge this turn.
