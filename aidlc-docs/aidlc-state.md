...
- **Current Stage**: CONSTRUCTION — **U4b merged to main 2026-07-25 (merge 7dbc709). Next unit: U7 Offline Resilience** (or refactor sub-unit R1 — user's choice). U1 merged 2026-07-24; U2+U8+U3+U4a+U4b merged 2026-07-25. Coding standard CS-1 (no ternaries) active for new code.
...
- [ ] CONSTRUCTION: U5 Judge, U6 Check-In (MAUI apps — build app-core lib + defer UI shell unless MAUI workload installed)
